...
void GuiApplication::afterOnSceneGraphInitialized()
{
  ...
  connect(&_window, &Window::beforeRendering, this, &GuiApplication::expandAnimeTiddies,
      Qt::DirectConnection);
  ...
  QString ha_id_var_close_app = _hidmanager.registerHidAction("Application", "Quit", "Close application!", &_window, SLOT(close()));
...
// Courtesy of Bjørn-Richard Pedersen
void GuiApplication::expandAnimeTiddies()
{
  _scenario.simulate();
}
